...
\begin{figure}[h]
  \centering\includegraphics[width=\textwidth]{ClassIII.png}
...
\begin{figure}[h]
  \centering\includegraphics[width=\textwidth]{FleetHybridModelDetailedEmb}
